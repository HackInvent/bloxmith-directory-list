...
(function () {
  ...
  const namespace = (window.CWDirectoryListBlockUi = window.CWDirectoryListBlockUi || {});
   ...
   * @returns {void}
   */
  namespace.mountDirectoryListEditor = function mountDirectoryListEditor(root, api, { actionName = "inspector_update_directory_list" } = {}) {
